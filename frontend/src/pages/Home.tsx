...
import { FormControl, FormLabel, IconButton, InputLabel, MenuItem, Paper, Radio, RadioGroup, Select, SelectChangeEvent } from '@mui/material';
...
export default function Home() {
  ...
  return (
    <ThemeProvider theme={defaultTheme}>
      <Container className="p-1" maxWidth="xl" sx={{ bgcolor: '#fff', mb: 2 }}>
        ...
        <div className="flex justify-between my-1">
          <div className="flex items-center">
            ...
            <Typography component="p" color="text.secondary" fontWeight={600}>
              Paso {activeStep + 1}/{steps + 1}: {activeStep === 0 ? 'Datos generales': activeStep === 1 ? 'Datos del auto' : activeStep === 2 ? 'Acerca de ti' : 'Cotización'}
            </Typography>
          </div>
          <IconButton aria-label="reset" onClick={(() => setStep(0))}>
            <RotateLeftIcon color='primary' sx={{ fontSize: '3rem' }} />
          </IconButton>
        </div>
      </Container>
        ...
        {activeStep === 0 ? (
            ...
            <Box component="form" className="flex flex-col justify-center items-center" noValidate sx={{ my: 3 }}>
              <FormControl>
                <RadioGroup row aria-labelledby="demo-radio-buttons-group-label" defaultValue="full" name="radio-buttons-group">
                  <Paper elevation={12} className="radio-card" sx={{ borderRadius: 3 }}>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <Box component="form" className="flex flex-col justify-center items-center" noValidate sx={{ my: 3 }}>
              <Grid container spacing={3} sx={{ width: '600px' }}>
                ...
                <Grid item xs={6}>
                  <TextField variant="standard" margin="normal" required fullWidth id="email" label="Año" name="year" autoComplete="año" autoFocus />
                </Grid>
                <Grid item xs={6}>
                  <FormControl variant="standard" fullWidth sx={{mt: 2}}>
                ...
                <Grid item xs={6}>
                  <TextField variant="standard" margin="normal" required fullWidth id="email" label="Costo" name="costo" autoComplete="email" autoFocus />
                </Grid>
              </Grid>
            </Box>
          </Box>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <Box component="form" className="flex flex-col justify-center items-center" noValidate sx={{ my: 3 }}>
              <Grid container spacing={3} sx={{ width: '600px' }}>
                ...
                <Grid item xs={12}>
                  <TextField variant="standard" margin="normal" required fullWidth id="email" label="Correo electrónico" name="email" autoComplete="email" autoFocus />
                </Grid>
                <Grid item xs={12}>
                  <TextField variant="standard" margin="normal" required fullWidth id="phone" label="Teléfono celular (optional)" name="phone" autoComplete="phone" autoFocus />
                </Grid>
              </Grid>
            </Box>
          </Box>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <Box component="form" className="flex flex-col justify-center items-center" noValidate sx={{ my: 3 }}>
              <FormControl>
                <RadioGroup row aria-labelledby="demo-radio-buttons-group-label" defaultValue="full" name="radio-buttons-group">
                  <Paper elevation={12} className="radio-card-cov" sx={{ borderRadius: 3 }}>
                    <DirectionsCarFilledIcon color='primary' sx={{ fontSize: '4rem' }} />
                    <FormControlLabel value="full" control={<Radio />} label="" sx={{ position: 'absolute', right: '0', top: '0.5rem' }} />
                    <Typography component="p" fontWeight={600}>
                      Resp. civil
                    </Typography>
                  ...
                  <Paper elevation={12} className="radio-card-cov" sx={{ borderRadius: 3 }}>
                    <CarCrashIcon color='primary' sx={{ fontSize: '4rem' }} />
                    <FormControlLabel value="third" control={<Radio />} label="" sx={{ position: 'absolute', right: '0', top: '0.5rem' }} />
                    <Typography component="p" fontWeight={600}>
                      Limitada
                    </Typography>
